...
export type BirthDatePickerInputProps = {
  id?: string;
...
const BirthDatePickerInput: React.FC<BirthDatePickerInputProps> = ({
  label,
  id,
  helperText,
  errorMessage,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="leading-[normal] mt-0.5 font-IRANSans-medium text-base">
            {value}
          </span>
        </span>
